...
## Project Overview
Cities: Skylines 2 mod that adds toggles to dispatch fire engines to car accidents and medical calls. Pure ECS approach — no Harmony patches.
...
## Architecture
- **Mod.cs**: `IMod` entry point — registers settings, localization, and 2 ECS systems
